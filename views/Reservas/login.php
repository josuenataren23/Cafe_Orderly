...
<form class="form" method="post" action="">
    <div class="flex-column">
      ...
      <div class="inputForm">
        ...
        <input type="text" class="input" placeholder="Ingresa tu correo">
      </div>
    ...
    <div class="flex-column">
      ...
      <div class="inputForm">
        ...
        <input type="password" class="input" placeholder="Ingresa tu">
    ...
    <p class="p">¿No tienes una cuenta? <span class="span">Registrate</span>
